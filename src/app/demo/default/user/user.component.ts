...
export default class UserComponent implements OnInit {
  ...
  editUser(user: User) {
    this.user = new FormGroup({
      ...
      userPhone: new FormControl(user.userPhone),
  ...
  deleteUser(id){
    console.log(id)
    this.authService.deleteUser("/v1/delete/", id).subscribe({
      next: (res) => {
  ...
  save() {
    ...
    let user = {
      user_email:this.user.value.userEmail,
      user_first_name:this.user.value.userFirstName,
      user_last_name:this.user.value.userLastName,
      user_phone:this.user.value.userPhone
    }
    this.authService.updateUser(user,"/v1/update/", id).subscribe({
      next: (res) => {
  ...
  getDashBoradData = () => {
    this.authService.getUsers("/v1/users").subscribe({
      next: (res) => {
        this.resTableData = res;
        console.log("Result", this.resTableData);
      },
      error: (e) => console.error(e),
      complete: () => console.info(this.resTableData),
    });
